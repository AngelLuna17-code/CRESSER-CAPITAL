...
function Calculator() {
  ...
  const [calculated, setCalculated] = useState(false); // Nuevo estado
    ...
    <section>
      <div className='container mx-auto grid grid-cols-1 lg:grid-cols-2 py-[50px] lg:py-[100px] px-[15px]'>
        <div className='flex items-center justify-center'>
          <div>
            ...
            <div className='flex justify-center mt-6'>
              <button className='rounded-full' style={{ boxShadow: calculated ? '0px 0px 5px 5px #9a7b46' : 'none' }} onClick={handleCoinClick}>
                <div className={`coin hover:bg-[#999999] ${calculated ? 'active' : ''}`} >
        ...
        <div>
          ...
          {/* Total */}
          <div className='mt-3'>
            <label htmlFor="total">Tu inversión asciende a:</label>
            <input
              className='w-full p-3 bg-[#1b1b1b] hover:bg-[#2c2a2a] mt-3'
              type="text"
              id="total"
