...
const Calculadora = () => {
    ...
    return (
        <section>
            <div className='container mx-auto py-[50px] lg:py-[100px] px-[10px] lg:px-[0px]'>
                            ...
                            <div className='flex items-center justify-center p-8'>
                                <div className="square">
                                    <div className="fill" style={{ height: `${(amount / 100000) * 100}%` }}>
                                        <svg className='text-[#ffffff]' xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
