                        ...
                        <div className='bg-[#1b1b1b] hover:bg-[#2c2a2a] p-2 lg:p-5 flex items-center justify-center'>
                            <div className=''>
                                <div class="flex justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 16 16" className="transition-transform transform hover:scale-110 text-[#a18144]">
