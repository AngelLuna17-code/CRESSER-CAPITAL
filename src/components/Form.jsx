...
function Form() {
    ...
    return (
        <section>
            <div id='contacto' className='w-full py-[50px] lg:py-[100px] px-[15px]'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5 mt-5'>
                        ...
                        <div >
                            <div className='grid grid-cols-2 gap-5'>
                                {/* Card 1 */}
                                <a href="https://www.google.com/maps/place/Quer%C3%A9taro+429-a,+Fray+Jun%C3%ADpero+Serra,+63169+Tepic,+Nay./@21.499418,-104.8992682,690m/data=!3m1!1e3!4m5!3m4!1s0x842736e4e6cb1897:0x86afa3963ae304db!8m2!3d21.5003709!4d-104.9005545?entry=ttu" target='blank'>
                                ...
                                {/* Card 2 */}
                                {/* Card 3 */}
                                <a href="mailto:contacto@cressercapital.com.mx">
                                    <div className='bg-[#1b1b1b] hover:bg-[#2c2a2a] p-5 flex items-center justify-center'>
                                        <div>
                                            <div className='flex justify-center'>
                                                <svg className="transition-transform transform hover:scale-110 cursor-pointer text-[#a18144]" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 16 16">
